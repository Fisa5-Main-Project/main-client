...
export default function Header({ hasBackButton = true, hasLogo = true, hasMyPage = true, title }: HeaderProps) {
    ...
    return (
        <header className="flex items-center justify-between h-[3.75rem] shrink-0 border-b border-gray-100/50 backdrop-blur-sm">
            ...
            <div className="flex-1 flex justify-center">
                {hasLogo && (
                    <Link href={PATHS.MAIN} className="flex items-center justify-center cursor-pointer">
                        {title ? (
