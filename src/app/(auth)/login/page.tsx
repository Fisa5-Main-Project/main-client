                ...
                {!isLogin ? (
                    ...
                    >
                        <div className="flex-1 flex flex-col items-center justify-center w-full">
                            <motion.div layoutId="logo-container" className="relative w-56 h-56 mb-10">
                                <Image
                            ...
                            >
                                ...
                                <p className="text-gray-500 font-medium">KNOWHOW에서 도와드릴게요</p>
                            </motion.div>
                        </div>
                        ...
                        >
                            <div className="flex flex-col items-center">
                                <h2 className="text-xl font-bold text-gray-900 mb-8 mt-6">
                                    로그인으로 <span className="text-[#0090FF]">노후준비</span> 시작하기
                                </h2>
